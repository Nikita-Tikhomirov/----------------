...
<script>
	document.addEventListener('DOMContentLoaded', () => {
		...
		function bindQuestionTriggers() {
			const selector = 'a[href="#modal-full"],a[href="#license-modal"],[uk-toggle*="#modal-full"]';
			document.querySelectorAll(selector).forEach(trigger => {
				trigger.textContent = 'ЗАДАТЬ ВОПРОС';
